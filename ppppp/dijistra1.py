...
class ClusteringGraph:
    ...
    def plot_dijkstra_graph(self):
        ...
        plt.tight_layout()
        save_path = "E:\B.Tech sem 4\project\IV SEM PROJ\ppppp\static\public\graph.png"
    ...
    def print_closest_centroid(self):
        ...
        self.closest_centroid=self.closest_centroid.tolist()
        centroid_lat=self.closest_centroid[0]
        centroid_lon=self.closest_centroid[1]

        e = {}
        e['coordinates'] = [centroid_lat, centroid_lon]
        with open('summa1.json', 'w') as f:
            json.dump(e, f)
...
# Usage example
# data_path = r"E:\B.Tech sem 4\MP & MC\ppppp\be\income.csv"
#
